         ...
         <div className="mx-8 sm:mx-16 xl:mx-24 relative ">
              <div className='text-center mt-20 mb-8'>
                ...
                <div className="inline-flex items-center justify-center gap-4 px-6 py-1.5 mb-4 border border-primary/40 bg-primary/10 rounded-full text-sm text-primary">
                    ...
                    <p className="my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500">This is your space to think out loud,to share what matters,and to share what matters,and to write without filters. whether its one word or a thousand, your story starts right here.</p>
                    ...
                    <form onSubmit={onSubmitHandler} className="flex justify-between max-w-lg max-sm:scale-75 mx-auto border border-gray-300 bg-white rounded overflow -hidden ">
                        <input ref={inputRef}  className="w-full pl-4 outline-none" type="text"  name="name" placeholder="search for blogs" required/>
